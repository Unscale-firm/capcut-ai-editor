# CHANGELOG — pull this file first, it is the state of the edit

## Increment status
| Increment | Window | Status |
|---|---|---|
...
- **2026-07-15** — Repo created. Map contains Increments 1–3 (3 = STAGED). Assets:
  ...
  editor build (sources to E3.25). Global caption table extended (locked myself in,
  six-figure career).
